...
emailDFrp$isSpam <- revalue(emailDFrp$isSpam, c("T"="Spam", "F"="Ham")) 
emailDFrp$isSpam <- relevel(emailDFrp$isSpam, "Spam")
...
# viz, decision boundaries for top 2 splitting features
...
# optimize for fnr, let's optimize both instead
