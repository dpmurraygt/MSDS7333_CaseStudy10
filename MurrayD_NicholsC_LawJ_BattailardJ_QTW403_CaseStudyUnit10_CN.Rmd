...
# show defaults
getParamSet(spam.lrn) # cp = 0.01, minsplit=20, maxdepth=30
...
# log these for better viz
plotLearnerPrediction(learner = spam.lrn, 
                      task = spam.tsk, 
...
thresh_plot = generateThreshVsPerfData(spam.pred, 
...
# tune parameters for our learner, task
...
df = generateThreshVsPerfData(list(base = spam.preds, optimized = spam.opt.preds), 
...
# try some nested resampling for unbiased errors
parallelStart(mode="multicore", cpus = 4)
