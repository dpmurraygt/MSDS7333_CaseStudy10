...
```{r chi_sq_cats, include=TRUE, cache=TRUE, fig.height=8, fig.width=8, warning=FALSE}
...
df %>% 
  ...
  theme(legend.position = "bottom", 
        axis.text.x = element_text(angle=90, vjust=0.5)) +
        scale_y_discrete("") + scale_x_discrete("Predictor Variable") + 
        ggtitle("Figure 4: Biserial Correlation for Factor and Continuous Variables")
...
Thus, we leave it up to rpart and its default parameters to create a decision tree containing 14 splits represented in Figure 9. This is our base model.
