...
```{r load_libs, include=FALSE, cache=TRUE, warning=FALSE}
library(magrittr)
library(reshape2)
library(plyr)
library(dplyr)
...
```{r chi_sq_cats, include=TRUE, cache=TRUE, fig.height=8, fig.width=8}
...
```{r biser_cor, include=TRUE, cache=TRUE, fig.height=8, fig.width=8.5}
...
```{r include = TRUE, cache = TRUE, fig.width=8.5, fig.height=6}
...
```{r fit_dtree_base, include=TRUE, fig.width=8.5, fig.height=5}
set.seed(4)
...
```{r tree_plot, include=TRUE, fig.width=8.5, fig.height=5}
...
```{r rpart_optimize, cache=TRUE, include=FALSE}
