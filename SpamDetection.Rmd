...
```{r naive_bayes_classify, include=FALSE}
...
isYelling = function(msg) {
  if ( "Subject" %in% names(msg$header) ) {
    # sub out for only alpha in subject if it exists
     ...
     if (nchar(el) > 0) 
       # return logical, if entire message is caps, then TRUE else FALSE
        nchar(gsub("[A-Z]", "", el)) < 1
     else 
       # else if no characters, FALSE
        FALSE
  } else 
