...
SpamCheckWords =
  c("viagra", "pounds", "free", "weight", "guarantee", "million", 
    ...
    "xxx", "porn", "just for you", "marijuana", "consolidation",
    "cheating", "please respond", "bonus cash", "prince", "personal loan",
    "loan", "pics")
